  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-3xl font-bold text-slate-800">Available Hospitals</h2>
          <p className="text-slate-600 mt-2 text-lg">Showing {mockHospitals.length} hospitals in your area</p>
        </div>
